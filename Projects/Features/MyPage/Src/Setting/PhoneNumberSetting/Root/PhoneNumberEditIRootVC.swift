...
final class PhoneNumberEditRootVC: TFBaseViewController {
  ...
  lazy var updateBtn = WhiteStrokeMediumButton(title: "핸드폰 번호 업데이트")
...
extension PhoneNumberEditRootVC: UITableViewDelegate {
...
extension PhoneNumberEditRootVC: UITableViewDataSource {
  ...
  func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    ...
    let imageView = UIImageView(image: DSKitAsset.Image.Icons.shield.image)
