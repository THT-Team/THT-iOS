...
public final class PhoneNumberInputVC: TFBaseViewController {
  ...
  private let backButtonTrigger = PublishRelay<Void>()
...
//    navigationController?.setNavigationBarHidden(true, animated: false)
  ...
  public override func defaultBackButtonAction() {
    backButtonTrigger.accept(())
  }
  ...
  public override func bindViewModel() {
    let input = ViewModel.Input(
      ...
      backButtonTap: backButtonTrigger.asDriverOnErrorJustEmpty()
    )
